...
local function EntityYeet(pid)
    ...
    Script.QueueJob(function()
        ...
        if vehicles then
            ...
            for _, vehObj in pairs(vehicles) do
                pcall(function()
                    ...
                    if handle and handle ~= 0 and handle ~= myVeh then
                        ...
                        if vx then
                            ...
                            if distSq < rangeSq and distSq > 16 then
        ...
        if yeetedCount > 0 then
            toast(SCRIPT_NAME, "Yeet: " .. yeetedCount .. " entities!")
        end
    end)
end
